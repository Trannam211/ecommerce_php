...
INSERT INTO `tbl_end_category` VALUES (3,'─Éß╗ông hß╗ô nam',1),(14,'├üo hoodie nß╗»',7),(15,'├üo kho├íc nß╗»',7),(18,'Quß║ºn jogger nam',8),(20,'├üo thun nam',9),(21,'├üo s╞í mi nam th╞░ß╗¥ng ng├áy',9),(25,'Gi├áy nam th╞░ß╗¥ng ng├áy',2),(26,'B├⌐ trai',10),(32,'─Éß║ºm nß╗»',7),(42,'Trang sß╗⌐c nß╗»',4),(60,'T├║i x├ích nß╗»',4),(61,'─Éiß╗çn thoß║íi v├á phß╗Ñ kiß╗çn',14),(62,'Tai nghe',14),(71,'Linh kiß╗çn gß║»n ngo├ái',15),(73,'Thiß║┐t bß╗ï v├á vß║¡t t╞░ y tß║┐',16);
...
CREATE TABLE `tbl_language` (
  ...
  PRIMARY KEY (`lang_id`)
) ENGINE=MyISAM AUTO_INCREMENT=164 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_mid_category` VALUES (1,'Phß╗Ñ kiß╗çn nam',1),(2,'Gi├áy nam',1),(4,'Phß╗Ñ kiß╗çn nß╗»',2),(7,'Quß║ºn ├ío nß╗»',2),(8,'Quß║ºn nam',1),(9,'├üo thun v├á ├ío s╞í mi nam',1),(10,'Quß║ºn ├ío trß║╗ em',3),(14,'Thiß║┐t bß╗ï ─æiß╗çn tß╗¡',4),(15,'M├íy t├¡nh',4),(16,'Ch─âm s├│c sß╗⌐c khß╗Åe',5);
...
INSERT INTO `tbl_service` VALUES (5,'Easy Returns','Return any item before 15 days!','service-5.png'),(6,'Free Shipping','Enjoy free shipping inside US.','service-6.png'),(7,'Fast Shipping','Items are shipped within 24 hours.','service-7.png'),(8,'Satisfaction Guarantee','We guarantee you with our quality satisfaction.','service-8.png'),(9,'Secure Checkout','Providing Secure Checkout Options for all','service-9.png'),(10,'Money Back Guarantee','Offer money back guarantee on our products','service-10.png');
...
INSERT INTO `tbl_slider` VALUES (1,'slider-1.png','Welcome to Ecommerce PHP','Shop Online for Latest Women Accessories','View Women Accessories','product-category.php?id=4&type=mid-category','Center'),(2,'slider-2.jpg','50% Discount on All Products','Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has.','Read More','#','Center'),(3,'slider-3.png','24 Hours Customer Support','Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has.','Read More','#','Right');
...
INSERT INTO `tbl_top_category` VALUES (1,'Nam',1),(2,'Nß╗»',1),(3,'Trß║╗ em',1),(4,'─Éiß╗çn tß╗¡',1),(5,'Sß╗⌐c khß╗Åe v├á gia dß╗Ñng',1);
...
-- Dump completed on 2026-03-26 14:15:29
