...
$redirect_after_register = ($redirect_target === 'checkout') ? 'checkout.php' : 'index.php';
?>
...
if (isset($_POST['form1'])) {
    ...
    if(isset($_POST['redirect']) && $_POST['redirect'] === 'checkout') {
        ...
        $redirect_after_register = 'checkout.php';
    }
    ...
    if($valid == 1) {
        ...
        $cust_password_hash = password_hash($cust_password_input, PASSWORD_DEFAULT);
