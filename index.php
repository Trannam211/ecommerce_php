...
<div id="bootstrap-touch-slider" class="carousel slide bs-slider bs-fade control-round indicators-line" data-ride="carousel" data-bs-ride="carousel" data-pause="hover" data-bs-pause="hover" data-interval="10000" data-bs-interval="10000" >
    ...
    <ol class="carousel-indicators">
        ...
        foreach ($result as $row) {            
            ?>
            <li data-target="#bootstrap-touch-slider" data-bs-target="#bootstrap-touch-slider" data-slide-to="<?php echo $i; ?>" data-bs-slide-to="<?php echo $i; ?>" <?php if($i==0) {echo 'class="active"';} ?>></li>
            <?php
            $i++;
        }
        ?>
    ...
    <div class="carousel-inner" role="listbox">
        ...
        foreach ($result as $row) {            
            ?>
            <div class="item carousel-item <?php if($i==0) {echo 'active';} ?>" style="background-image:url(assets/uploads/<?php echo $row['photo']; ?>);">
                ...
                <div class="container">
                    <div class="row">
                        <div class="slide-text <?php if($row['position'] == 'Left') {echo 'slide_style_left';} elseif($row['position'] == 'Center') {echo 'slide_style_center';} elseif($row['position'] == 'Right') {echo 'slide_style_right';} ?>">
                            ...
                            <a href="<?php echo $row['button_url']; ?>" class="btn btn-primary" data-animation="animated <?php if($row['position'] == 'Left') {echo 'fadeInLeft';} elseif($row['position'] == 'Center') {echo 'fadeInDown';} elseif($row['position'] == 'Right') {echo 'fadeInRight';} ?>"><?php echo $row['button_text']; ?></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Slider Left Control -->
    <a class="left carousel-control carousel-control-prev" href="#bootstrap-touch-slider" role="button" data-slide="prev" data-bs-slide="prev">
        <span class="fa fa-angle-left" aria-hidden="true"></span>
        <span class="sr-only visually-hidden">Trước</span>
    </a>

    <!-- Slider Right Control -->
    <a class="right carousel-control carousel-control-next" href="#bootstrap-touch-slider" role="button" data-slide="next" data-bs-slide="next">
        <span class="fa fa-angle-right" aria-hidden="true"></span>
        <span class="sr-only visually-hidden">Sau</span>
    </a>
