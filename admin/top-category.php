...
<section class="content-header">
	<div class="content-header-left">
        <h1>Danh sách danh mục cấp 1</h1>
	</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Lưu ý: Toàn bộ sản phẩm, danh mục cấp 2 và danh mục cấp 3 thuộc danh mục cấp 1 này sẽ bị xóa khỏi các bảng liên quan (đơn hàng, thanh toán, kích cỡ, màu sắc, đánh giá...).</p>
            </div>
