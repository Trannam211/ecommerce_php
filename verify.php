...
if ( (!isset($_REQUEST['email'])) || (isset($_REQUEST['token'])) )
{
    ...
    if($var != 0)
    {
        ...
        $success_message = '<p style="color:green;">Email của bạn đã được xác thực thành công. Bây giờ bạn có thể đăng nhập vào website.</p><p><a href="'.BASE_URL.'login.php" style="color:#167ac6;font-weight:bold;">Bấm vào đây để đăng nhập</a></p>';     
    }
}
?>
