...
if(isset($_POST['form_contact']))
{
    ...
    else
    {
        ...
        {
            $valid = 0;
            $error_message .= 'Vui lòng nhập đúng định dạng email.\n';
        }
    }
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="visitor_name" placeholder="Nhập họ tên">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Nội dung tin nhắn</label>
