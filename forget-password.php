...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $message = '<p>'.'Để đặt lại mật khẩu, vui lòng bấm vào liên kết bên dưới.'.'<br> <a href="'.BASE_URL.'reset-password.php?email='.$_POST['cust_email'].'&token='.$token.'">Bấm vào đây</a>';
