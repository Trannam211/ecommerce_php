        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo format_price_vnd($arr_cart_p_current_price[$i]); ?></td>
                        ...
                        <tr>
                            ...
                            <th class="total-amount"><?php echo format_price_vnd($table_total_price); ?></th>
                        </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <td class="total-amount"><?php echo format_price_vnd($shipping_cost); ?></td>
                        </tr>
                        <tr>
                            ...
                            <th class="total-amount">
                                ...
                                ?>
                                <?php echo format_price_vnd($final_total); ?>
                            </th>
                        </tr>
                    </table> 
                </div>
                ...
                <div class="cart-buttons">
                    <ul>
                        <li><a href="cart.php" class="btn btn-primary">Tiếp tục mua sắm</a></li>
                    </ul>
                </div>
                ...
                <div class="row">
		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
                                ...
                                Bạn cần cập nhật đầy đủ thông tin thanh toán và giao hàng trong trang tài khoản trước khi đặt hàng. Vui lòng cập nhật tại <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">đường dẫn này</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
									...
									<form action="<?php echo BASE_URL; ?>payment/bank/init.php" method="post" id="bank_form">
